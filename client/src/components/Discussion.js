        ...
        <Card className="mx-auto">
          <CardBody className="discussion-body">
            ...
            <footer className="post-footer">
              <p>
                Opublikowano: {this.state.date} by {this.state.author}
              </p>
              <div>
                <Button href={"/edit-post/" + this.state.id} className="mr-2">
                  Edit Post
                </Button>
